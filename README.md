...
6개 영역, 40건+ 분석·구축 이력입니다. 전체 목록은 [PROJECTS.md](PROJECTS.md)에 시기·수행 내용·핵심 기법과 함께 정리되어 있습니다 (⭐ 포트폴리오 수록 6건, 🖼 재현 샘플 링크 포함).

| 영역 | 대표 프로젝트 |
|---|---|
| 🧪 실험 설계 · A/B 테스트 | 결제수단 전환 A/B 1차 → 후속 재설계로 **CAC 약 30% 절감**, 리워드 지급방식 RCT(이종 장르 재현), 이탈 방어 Win-back(예측모델 + Uplift 실험 설계) |
...
2. **성과는 상대 수치로만 표기합니다.** 내부 실적의 절대값은 제외하고, 방법론과 판단 근거만 남겼습니다.
...
*이 저장소는 계속 업데이트됩니다. (Last updated: 2026.09)*
